...
class Copy(object):
    ...
    def create_roles(self):
        ...
        for role in roles:
            ...
            if new_role.get("code"):
                print(f"\033[91mMissing Permissions \033[35m[\033[1;30;48m{role['name']}\033[35m]\u001b[0m")
                continue
            print(f"\033[1;37;0mCreate role \033[35m[\033[1;30;48m{role['name']}\033[35m]\u001b[0m")
    ...
    def copy_channels(self):
        def permission(_channel):
            ...
            roles_cache = cache.get("roles", {})  # Si no existe la clave 'roles', se usa un diccionario vacío como valor predeterminado
            for per in _channel["permission_overwrites"]:
             if per["type"] == 1:
              continue
             if not roles_cache.get(per["id"]) and per["id"] == self.guild.default_role["id"]:
               per["id"] = self.to_guild.default_role["id"]
               permission_overwrites.append(per)
               continue
             per["id"] = roles_cache.get(per["id"], per["id"])  # Usar el valor actual si no se encuentra en el caché de roles
             permission_overwrites.append(per)
        ...
        for channel in free_channels:
            ...
            if o.get("code"):
                print(f"\033[1;37;0mMissing Permissions \033[35m[\033[1;30;48m{channel['name']}\033[35m]\u001b[0m")
                continue
            print(f"\033[1;37;0mCreate channel \033[35m[\033[1;30;48m{channel['name']}\033[35m]\u001b[0m") 
        for category in categorys:
            ...
            if new_category.get("code"):
                print(f"\033[91mMissing Permissions \033[35m[\033[1;30;48m{category['name']}\033[35m]\u001b[0m")
                continue
            print(f"\033[1;37;0mCreate category \033[35m[\033[1;30;48m{category['name']}\033[35m]\u001b[0m")
        ...
        for channel in channels:
            ...
            if o.get("code"):
                print(f"\033[91mMissing Permissions \033[35m[\033[1;30;48m{channel['name']}\033[35m]\u001b[0m")
                continue
            print(f"\033[1;37;0m Create channel \033[35m[\033[1;30;48m{channel['name']}\033[35m]\u001b[0m")
        cache.clear()            
    ...
    def create_emojis(self):
        ...
        for emoji in emojis:
            ...
            if o.get("code"):
                print(f"\033[91mMissing Permissions \033[35m[\033[1;30;48m{emoji['name']}\033[35m]\u001b[0m")
                continue
            print(f"\033[1;37;0m Create emoji \033[35m[\033[1;30;48m{emoji['name']}\033[35m]\u001b[0m")
